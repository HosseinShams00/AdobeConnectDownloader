...
namespace AdobeConnectDownloader
{
    public partial class MainForm : Form
    {
        ...
        private void ZipProcessButton_Click(object sender, EventArgs e)
        {
        ...
        private void DownloadQueeButton_Click(object sender, EventArgs e)
        {
            ...
            {
                foreach (DataGridViewRow quee in ProcessDataGridView.Rows)
                {
                    string url = (string)quee.Cells[0].Value;
                    string WorkFolderPath = (string)quee.Cells[1].Value;
                    ...
                    {
                        copyDataGridView.Rows.Remove(quee);
                    }
